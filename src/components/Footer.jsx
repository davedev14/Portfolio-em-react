  ...
  return (
    <footer className='py-12 px-4 bg-card relative border-t border-border mt-12 pt-8 flex flex-wrap justify-between items-center'>
         <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-heading uppercase">me siga</h2>
                  <ul class="text-body font-medium">
                      <li class="mb-4">
                          <a href="https://github.com/davedev14" class="hover:underline ">Github</a>
                      </li>
                      <li>
                          <a href="https://www.instagram.com/dvisald/" class="hover:underline">Instagram</a>
                      </li>
                  </ul>
              </div>
              <div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-body sm:text-center">&copy; {new Date().getFullYear()} <a class="hover:underline">Davedev14™</a>. Todos os direitos reservados.
          </span>
          <div class="flex mt-4 sm:justify-center sm:mt-0">
            ...
            <a href="#" target="_blank" rel="noopener noreferrer" class="text-body hover:text-heading ms-5" aria-label="Substack">
                <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                <path d="M22.539 4.242H1.461V0h21.078v4.242zM1.461 6.863h21.078v4.242H1.461V6.863zM1.461 13.725h21.078V24L12 18.281 1.461 24v-10.275z"/>
                </svg>
                <span class="sr-only">Substack account</span>
            </a>
          </div>
      </div>
